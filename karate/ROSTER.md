# Black Belt Lineage Roster

Snapshot of every black belt in the Tabata Sensei lineage and connected federations. Mirrors `data.js` in human-readable form. Update both when adding people or ranks.

**Live page:** https://giovannielabs.ai/karate/
...
| Org | Color | Logo |
|---|---|---|
| Tabata Sensei | gold `#F5C518` | logos/tabata.jpeg |
| JKA | blue `#2A6FDB` | logos/jka.jpeg |
| JUKF | red `#E63946` | logos/jukf.jpeg |
| HDKI | purple `#8B5CF6` | logos/hdki.jpeg |
| ISKF | deep red `#991B1B` | (no logo yet) |

## Dan Ranks (1st through 10th)

| Dan | Name | Color |
|---|---|---|
| 1 | Shodan | orange `#FF8C42` |
| 2 | Nidan | blue `#3B82F6` |
| 3 | Sandan | green `#10B981` |
| 4 | Yondan | purple `#8B5CF6` |
| 5 | Godan | red `#EF4444` |
| 6 | Rokudan | teal `#14B8A6` |
| 7 | Shichidan | pink `#EC4899` |
| 8 | Hachidan | indigo `#6366F1` |
| 9 | Kudan | bronze `#D97706` |
| 10 | Judan | gold `#F5C518` |

## Universities (10)

Boston University · Columbia University · Georgetown University · Harvard University · Lesley University · MIT · NYU · UConn · UMass Amherst · University of Texas · Wellesley College
...
- **Source of truth:** `karate/data.js`. Every change there auto-deploys via Vercel.
- **Photos:** dropped into `karate/photos/`. Filenames matter (referenced from `data.js`).
- **Org logos:** in `karate/logos/`. ISKF logo still missing.
- **Update this file** when editing `data.js` so the markdown stays in sync. (A later script or MCP could automate this.)
